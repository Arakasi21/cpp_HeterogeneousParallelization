...
int main(){
    ...
    // ну у меня машина мощная, поэтому возьмем большой массив... Потому что на более меньших массивах разница во времени может быть незначительной (0.22 сек против 0.18 сек и т.д.)
    int N = 100000000;
    int* arr = new int[N];
