...
В моем случае -> когда изначальное кол-во элементов в массиве мала, и параллелизация будет не эффективной. Также зависимость результата итераций друг от друга - условно array[i] = array[i-1] + array[i]